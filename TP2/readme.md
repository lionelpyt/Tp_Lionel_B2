...
- [III. Services réseau](#iii-services-réseau)
  - [1. Web web web](#1-web-web-web)
  - [2. Or is it ? Bonus : DHCP](#2-or-is-it--bonus--dhcp)
...
- setup du service Web, la marche à suivre :
  - installation de NGINX
  - gestion de la racine web `/var/www/site_nul/`
    - faut créer le dossier
    - et gérer les permissions correctement dessus
    - vous pouvez y mettre un simple fichier `index.html` pour vos tests
  - configuration NGINX
